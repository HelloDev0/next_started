                    ...
                    <table className='table-fixed w-full'>
                        <thead className='bg-gray-700/20 rounded'>
                            <tr >
                                ...
                                <th className='p-3 text-xs'>Groups Name</th>
                                <th className='p-3 text-xs'>Contact Name</th>
                        ...
                        <tbody className=''>
                            <tr className='border-2 border-b-gary-600'>
                                ...
                                <td className='py-4 pl-16'><i class="fas fa-edit text-gray-700/90"></i> <i class="fas fa-user-check text-[#34c38f] ml-3"></i></td>
                            </tr>
                            <tr className='border-2 border-b-gary-600'>
                                <td className='py-4 pl-16'><a className='text-white bg-[#556ee6] rounded-full py-2 px-[1rem]'>p</a></td>
                                <td className='py-4 pl-16'><a className='text-gray-700 text-xs font-medium'>Prism Hr</a></td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td className='py-4 pl-16'><button className='text-blue-500 bg-[#556ee6]/30 text-xs rounded p-0.5'>Active</button></td>
                            ...
                            <tr className='border-2 border-b-gary-600'>
                                <td className='py-4 pl-16'><a className='text-white bg-[#556ee6] rounded-full py-2 px-[1rem]'>p</a></td>
                                <td className='py-4 pl-16'><a className='text-gray-700 text-xs font-medium'>Payroll Medics</a></td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td className='py-4 pl-16'><button className='text-blue-500 bg-[#556ee6]/30 text-xs rounded p-0.5'>Active</button></td>
