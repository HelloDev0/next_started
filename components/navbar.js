                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <h4 className='text-success px-4'>Welcome {userDetail}<i class="far fa-smile text-success"></i></h4>
                        </ul>
                        ...
                        <div class="d-flex">
                            ...
                            onClick={clearSearch}><i class="far fa-times-circle"></i>clear</button>
                            ...
                            {!userDetail ? (
                                <div className="d-flex">
                                    <button class="btn btn-outline-warning my-2 mx-2 my-sm-0">
